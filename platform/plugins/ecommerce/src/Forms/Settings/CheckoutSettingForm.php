...
class CheckoutSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                'checkout_apply_discount_before_taxes',
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->label(trans('plugins/ecommerce::setting.checkout.form.checkout_apply_discount_before_taxes'))
                    ->value(get_ecommerce_setting('checkout_apply_discount_before_taxes', false))
                    ->helperText(trans('plugins/ecommerce::setting.checkout.form.checkout_apply_discount_before_taxes_help'))
            )
