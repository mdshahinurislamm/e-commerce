...
class PublicCheckoutController extends BaseController
{
    ...
    public function getCheckout(
        ...
        if (view()->exists($checkoutView = Theme::getThemeNamespace('views.ecommerce.orders.checkout'))) {
            return view($checkoutView, $data);
        }

        return view(
            'plugins/ecommerce::orders.checkout',
            ['orderAmount' => $checkoutOrderData->orderAmount, 'checkoutForm' => CheckoutForm::createFromArray($data)]
        );
    }
