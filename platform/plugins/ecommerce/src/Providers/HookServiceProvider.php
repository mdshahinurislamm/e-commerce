...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        add_filter(FILTER_ECOMMERCE_PROCESS_PAYMENT, function (array $data, Request $request) {
            ...
            switch ($request->input('payment_method')) {
                case PaymentMethodEnum::COD:
                    ...
                    $minimumOrderAmount = get_payment_setting('minimum_amount', PaymentMethodEnum::COD, 0);
                ...
                case PaymentMethodEnum::BANK_TRANSFER:
                    ...
                    $minimumOrderAmount = get_payment_setting('minimum_amount', PaymentMethodEnum::BANK_TRANSFER, 0);
        ...
        add_filter('payment_method_display_body', function (?string $html, string $paymentName, ?string $paymentLabel) {
            $minimumOrderAmount = get_payment_setting('minimum_amount', $paymentName, 0);
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'attributes' => [
                            ...
                            'options' => [
                                'class' => 'form-control',
                                'placeholder' => 'https://example.com/merchant-return-policy',
                            ],
                        ],
                        'priority' => 1000,
                    ],
