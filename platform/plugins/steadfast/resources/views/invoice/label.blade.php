...
<body>
    <div class="label-container">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: auto; text-align: right;">
                        <img src="{{ asset('public/storage/' . $company_logo) }}" alt="Logo" class="logo">
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="section" style="border-bottom: 2px solid black;">
            <h2>{{ $customer_name }}</h2>
            <h4>{{ $customer_address }}, {{ $customer_city }}, {{ $customer_state }}<br>{{ $customer_country }}, {{ $customer_zip_code }}</h4>
            ...
            <table>
                <tr>
                    <td style="padding-bottom: 5px;">
                        <span>Parcel ID:</span>
                        <h3>{{ $steadfast_consignment_id }}</h3>
                    </td>
                    <td style="padding-bottom: 5px;">
                        <span>Order ID:</span>
                        <h3>{{ $order_code }}</h3>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <h3>{{ !empty($steadfast_amount) ? $steadfast_amount : $total_amount }}</h3>
                    </td>
                </tr>
            </table>
        </div>
