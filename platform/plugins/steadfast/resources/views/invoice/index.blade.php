...
<div class="tm_container">
            ...
            <div class="tm_invoice_in">
                <div class="tm_invoice_head tm_align_center tm_mb20">
                    <div class="tm_invoice_left">
                        <div class="tm_logo"><img src="{{  asset('public/storage/'.$company_logo) }}" alt="Business Logo"></div>
                ...
                <div class="tm_invoice_info tm_mb20">
                    ...
                    <div class="tm_invoice_info_list">
                        <p class="tm_invoice_number tm_m0">Invoice No: <b class="tm_primary_color">{{ $order_code }}</b></p>
                        <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">{{ $order_date }}</b></p>
                    </div>
                </div>
                ...
                <div class="std-consignment">
                    <div class="tm_padd_15_20 tm_round_border">
                        <div class="tm_mb10 tm_invoice_head tm_align_center">
                            <div class="tm_invoice_left">
                                <h3 class="tm_mb3"><b class="tm_primary_color">For SteadFast Courier LTD</b></h3>
                            </div>
                            <div class="tm_invoice_right tm_text_right invoice_img stdf-courier-logo">
                                <img src="" id="SteadFast_logo" alt="SteadFast Logo">
                            </div>
                        </div>
                        <hr class="hr">
                        <div class="tm_invoice_head tm_mb10">
                            <div class="tm_invoice_left">
                                <h5 class="tm_mb2"><b class="tm_primary_color">Parcel ID: #{{ $steadfast_consignment_id }}</b></h5>
                            </div>
                            ...
                            <div class="tm_invoice_right tm_text_right">
                                <h5 class="tm_mb2">
                                    <b class="tm_primary_color">
                                        COD Amount: &#2547;
                                        {{ !empty($steadfast_amount) ? $steadfast_amount : $total_amount }}
                                    </b>
                                </h5>
                            </div>
                        </div>
                ...
                <div class="tm_table tm_style1 tm_mb30">
                    ...
                    <div class="tm_invoice_footer std-payment-info">
                        <div class="tm_left_footer">
                            ...
                            <p class="tm_m0">{{ $order_payment_method }}</p>
                        </div>
                        <div class="tm_right_footer">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">&#2547;{{ $shipping_amount }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr class="tm_border_top tm_border_bottom">
                                    ...
                                    <td class="tm_width_3 tm_border_top_0 tm_border_bottom tm_bold tm_f16 tm_primary_color tm_text_right">&#2547;{{ $total_amount }}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <script>
        ...
        document.getElementById('SteadFast_logo').src = image_data;
   </script>
