...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your username on Envato','name' => 'buyer','value' => 'xxxxx','id' => 'buyer','placeholder' => 'Your Envato\'s username','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$manageLicense)]); ?>
...
<?php if (isset($component)) { $__componentOriginala5b2ce8ea835a1a6ed10854da20fa051 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala5b2ce8ea835a1a6ed10854da20fa051 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::form.text-input','data' => ['label' => 'Purchase code','name' => 'purchase_code','value' => ''.e($randomCode).'','id' => 'purchase_code','disabled' => !$manageLicense,'placeholder' => 'Ex: 10101000-0101-0100-0010-001101000010']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('core::form.text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Purchase code','name' => 'purchase_code','value' => ''.e($randomCode).'','id' => 'purchase_code','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$manageLicense),'placeholder' => 'Ex: 10101000-0101-0100-0010-001101000010']); ?>
     <?php $__env->slot('helperText', null, []); ?> 
        <a
...
<?php /**PATH F:\xamp\htdocs\mimi\platform/core/base/resources/views/components/license/form.blade.php ENDPATH**/ ?>