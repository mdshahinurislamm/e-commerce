<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($item->ads_type === 'google_adsense' && $item->google_adsense_slot_id): ?>
        <div <?php echo Html::attributes($attributes); ?>>
            <?php echo $__env->make('plugins/ads::partials.google-adsense.unit-ads-slot', ['slotId' => $item->google_adsense_slot_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php continue; ?>
    <?php endif; ?>
...
<?php /**PATH F:\xamp\htdocs\mimi\platform/plugins/ads/resources/views/partials/ad-display.blade.php ENDPATH**/ ?>