                    ...
                    >
                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a
                                ...
                                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link w-100', 'active' => $currentSection['id'] === $section['id']]); ?>"
...
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => $section['icon']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\mimi\platform/packages/theme/resources/views/options.blade.php ENDPATH**/ ?>