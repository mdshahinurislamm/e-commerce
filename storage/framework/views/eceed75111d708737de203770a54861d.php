    <footer id="footer">
        ...
        <div class="container-xxxl">
            <div class="row border-top">
                <div class="col-lg-3 col-md-4 py-1">
                    <div class="copyright d-flex justify-content-center justify-content-md-start">
                        <span><?php echo Theme::getSiteCopyright(); ?></span>
                    </div>
                </div>
                <div class="col-lg-6 col-md-4 py-1">
                        <!-- <div class="footer-payments d-flex justify-content-center"> -->
                            <!-- <p class="footer-copyright-text">Powered by <a href="http://www.aamrainfotainment.com"><img style="vertical-align:middle; float:none !important; margin-right:1px;" src="https://devs.ailservers.com/mimibazar/public/storage/logo-black.webp"></a></p></div> -->
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'ccf469bf367e9d43e8287323c43b8fe7::fronts.ajax-search.index','data' => ['class' => 'form--quick-search bb-form-quick-search w-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'ccf469bf367e9d43e8287323c43b8fe7::fronts.ajax-search.input','data' => ['type' => 'text','class' => 'search-field input-search-product']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('packages/theme::toast-notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </body>

    </html>
<?php /**PATH F:\xamp\htdocs\mimi\platform\themes/farmart/partials/footer.blade.php ENDPATH**/ ?>