            ...
            <div class="col-md-9">
                ...
                >
                    ...
                    <?php if(EcommerceHelper::isReviewEnabled()): ?>
                        ...
                        >
                            <?php echo $__env->make('plugins/ecommerce::themes.includes.reviews', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    <?php endif; ?>
                    <?php if(is_plugin_active('marketplace') && $product->store_id): ?>
                        <div
                    ...
                    <?php if(is_plugin_active('faq') && count($product->faq_items) > 0): ?>
                        ...
                        >
                            <?php echo $__env->make('plugins/ecommerce::themes.includes.product-faqs', ['faqs' => $product->faq_items], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH F:\xamp\htdocs\mimi\platform\themes/farmart/views/ecommerce/product.blade.php ENDPATH**/ ?>