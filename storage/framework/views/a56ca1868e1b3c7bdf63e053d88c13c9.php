...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::table.index','data' => ['hover' => false,'striped' => false,'class' => 'order-products-table']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['hover' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'striped' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'order-products-table']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::table.body.cell','data' => ['style' => 'width: 80px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'width: 80px']); ?>
                    <img
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::table.body.cell','data' => ['style' => 'width: 45%','class' => 'text-start']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'width: 45%','class' => 'text-start']); ?>
                    <div class="d-flex align-items-center flex-wrap">
                        <?php if($editProductRoute): ?>
                            <a
                                href="<?php echo e($product->getKey() && $product->original_product->getKey() && route($editProductRoute, $product->original_product->getKey())); ?>"
                        ...
                        <?php else: ?>
                            <span class="me-2"><?php echo e($orderProduct->product_name); ?></span>
                        <?php endif; ?>

                        <?php if($sku = Arr::get($orderProduct->options, 'sku') ?: ($product && $product->sku ? $product->sku : null)): ?>
                            <p class="mb-0">(<?php echo e(trans('plugins/ecommerce::order.sku')); ?>: <strong><?php echo e($sku); ?></strong>)</p>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php echo apply_filters(ECOMMERCE_ORDER_DETAIL_EXTRA_HTML, null, $orderProduct, $order); ?>

                    <?php echo apply_filters('ecommerce_order_product_item_extra_info', null, $orderProduct, $order); ?>
                            ...
                            <li>
                                ...
                                <?php if($isInAdmin): ?>
                                    <a
                                        ...
                                        href="<?php echo e(route('ecommerce.shipments.edit', $order->shipment->id)); ?>"
                                        title="<?php echo e($order->shipping_method_name); ?>"
                                        target="_blank"
                                    ><?php echo e($order->shipping_method_name); ?></a>
                                <?php else: ?>
                                    <span class="text-underline bold-light"><?php echo e($order->shipping_method_name); ?></span>
                                <?php endif; ?>
                            </li>

                            <?php if($isInAdmin && is_plugin_active('marketplace') && $order->store->name): ?>
                                <li class="ws-nm">
                                    <span class="bull">↳</span>
                                    <span
...
<?php endif; ?>
<?php /**PATH F:\xamp\htdocs\mimi\platform/plugins/ecommerce/resources/views/orders/edit/order-products.blade.php ENDPATH**/ ?>