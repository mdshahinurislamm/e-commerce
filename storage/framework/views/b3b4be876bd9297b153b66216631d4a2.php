...
function updateDeliveryStatus(orderId, buttonElement) {
    ...
    $.ajax({
        url: '<?php echo e(route("steadfast.delivery-status")); ?>', 
        method: 'POST',
        data: {
            id: orderId,
            _token: '<?php echo e(csrf_token()); ?>' 
...
function showError(id, buttonElement) {
        ...
        $.ajax({
            url: '<?php echo e(route("steadfast.show-error")); ?>', 
            method: 'POST',
            data: {
                id: id,
                _token: '<?php echo e(csrf_token()); ?>' 
...
function sendAmount(id, buttonElement) {
    ...
    $.ajax({
        url: '<?php echo e(route('steadfast.create-order')); ?>', // Your route for sending a single order
        method: 'POST',
...
$(document).ready(function () {
    ...
    $('#bulkSendToSteadfast').on('click', function () {
        ...
        $.ajax({
            url: '<?php echo e(route('steadfast.create-order')); ?>', // Your route for bulk orders
            method: 'POST',
            contentType: 'application/json', // Ensure we send JSON content
            data: JSON.stringify({
...
var selectedOrderIds = [];
 ...
 $.ajax({
     url: '<?php echo e(route("steadfast.bulk-print-invoice")); ?>', // Update this to match your route name
     method: 'POST',
...
function fetchOrderData(phoneNumber, cmsChecked, apiChecked) {
    ...
    $.ajax({
        url: '<?php echo e(route('steadfast.fake-order-check')); ?>',  // Your endpoint here
        method: 'get',
        data: {
            number: phoneNumber,
...
<script>
 $('#balanceButton').on('click', function () {
    ...
    $.ajax({
      url: '<?php echo e(route('steadfast.check-amount')); ?>', // Replace with the actual route to your controller method
      type: 'get',
      dataType: 'json',
      success: function (response) {
...
</script><?php /**PATH F:\xamp\htdocs\mimi\platform/plugins/steadfast/resources/views/partial/script.blade.php ENDPATH**/ ?>